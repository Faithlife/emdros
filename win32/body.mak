...
CPPFLAGS_EXTRA = $(DB_CPPFLAGS)  $(TECKIT_CPPFLAGS_EXTRA) /EHsc /D"LINUX=0"
...
!IF "$(DEBUG)" == "1"
# DEBUG build
DEBUG_SENSITIVE_CPPFLAGS = /MDd /W4 /Od /Zi \
...
# non-debug build
DEBUG_SENSITIVE_CPPFLAGS = /MD /W3 /O2 /D"NDEBUG=1"   /D_CRT_SECURE_NO_WARNINGS=1  /D_SCL_SECURE_NO_WARNINGS=1
!ENDIF
