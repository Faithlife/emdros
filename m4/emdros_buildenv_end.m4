...
if test x$DEVEL = xyes; then
   ...
   EMDROS_LDADD="${IMPORTERS_LDADD} ${UTIL_LDADD} ${HARVEST_LDADD} ${MQL_LDADD} ${EMDF_LDADD} ${SQLITE3_LDADD} ${PCRE2_LDADD} -lpthread -ldl -L/usr/bin -lsqlite3"
   EMDROS_LDADD_BACKBACK="${IMPORTERS_LDADD_BACKBACK} ${UTIL_LDADD_BACKBACK} ${HARVEST_LDADD_BACKBACK} ${MQL_LDADD_BACKBACK} ${EMDF_LDADD_BACKBACK} ${SQLITE3_LDADD_BACKBACK} ${PCRE2_LDADD_BACKBACK} -lpthread -ldl -L/usr/bin -lsqlite3"
   EMDROS_LDADD_BACKBACKBACK="${IMPORTERS_LDADD_BACKBACKBACK} ${UTIL_LDADD_BACKBACKBACK} ${HARVEST_LDADD_BACKBACKBACK} ${MQL_LDADD_BACKBACKBACK} ${EMDF_LDADD_BACKBACKBACK} ${SQLITE3_LDADD_BACKBACKBACK} ${PCRE2_LDADD_BACKBACKBACK} -lpthread -ldl -L/usr/bin -lsqlite3"
   ...
   EMDROS_LDADD="${EMDROS_LDADD} $PG_LDADD $MY_LDADD -lpthread -ldl -L/usr/bin -lsqlite3"
   EMDROS_LDADD_BACKBACK="${EMDROS_LDADD_BACKBACK} $PG_LDADD $MY_LDADD -lpthread -ldl -L/usr/bin -lsqlite3"
   EMDROS_LDADD_BACKBACKBACK="${EMDROS_LDADD_BACKBACKBACK} $PG_LDADD $MY_LDADD -lpthread -ldl -L/usr/bin -lsqlite3"
